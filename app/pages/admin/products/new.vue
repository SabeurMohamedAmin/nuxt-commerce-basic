    ...
    <v-row>
      <v-col cols="12" md="8">
        ...
        <v-card variant="outlined" rounded="lg" class="pa-6 mb-6">
          ...
          <FileUploadZone
            ...
            empty-text="Drag & drop an image or click to browse"
        ...
        <v-card variant="outlined" rounded="lg" class="pa-6">
          ...
          <p class="text-body-2 text-grey mb-4">Upload the downloadable ZIP file that buyers will receive.</p>
          <FileUploadZone
            accept=".zip,.rar,.7z"
            :file="form.file"
            empty-icon="mdi-folder-zip"
            empty-text="Drag & drop a ZIP file or click to browse"
      ...
      <v-col cols="12" md="4">
        <v-card variant="outlined" rounded="lg" class="pa-6 mb-6">
          ...
          <v-btn block color="primary" size="large" @click="saveProduct">
